# Skills: Campaign Analyst

## Bereits sinnvoll nutzbare Skills

- `finance/excel-author`: strukturierte Tabellen und Reports, wenn installiert.
- `research/parallel-cli`: parallele Daten- oder Quellenarbeit, wenn passend.
- `creative/excalidraw`: Funnel, Messarchitektur und Experimentdesign visualisieren.
